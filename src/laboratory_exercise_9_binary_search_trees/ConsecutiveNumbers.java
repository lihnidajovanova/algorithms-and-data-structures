...
public class ConsecutiveNumbers {
    // Function to check if every next element is equal to the previous element + 2
    public static boolean checkConsecutiveNumbers(BNode<Integer> root) {
        ...
        while (!stack.isEmpty()) {
            ...
            // Check if the current node's value is equal to the previous value + 2
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Check if consecutive and print the result
        boolean isValid = checkConsecutiveNumbers(tree.root);
