package auditory_exercises_10_introduction_to_graphs;
...
public class AdjacencyListGraph<T> {
    ...
    public boolean bidirectionalSearch(T startVertex, T endVertex) {
        ...
        Queue<T> queueFromStart = new LinkedList<>();
        Queue<T> queueFromEnd = new LinkedList<>();

        visitedFromStart.add(startVertex);
        queueFromStart.add(startVertex);

        visitedFromEnd.add(endVertex);
        queueFromEnd.add(endVertex);
